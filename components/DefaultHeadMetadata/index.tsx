...
export default function DefaultHeadMetadata() {
  return (
    <Head>
      ...
      <meta name="apple-mobile-web-app-capable"  content="yes" key="apple-web-app" />
      <meta name="mobile-web-app-capable"  content="yes" key="mobile-web-app" />
      {/* Icons */}
      <meta name="msapplication-square310x310logo"  content="/static/icon/ms-310.png" key="ms-icon-310" />
      ...
      <link rel="apple-touch-icon" sizes="152x152" href="/static/icon/apple-152.png" key="apple-icon-152" />
      <link rel="apple-touch-icon" sizes="144x144" href="/static/icon/apple-144.png" key="apple-icon-144" />
      <link rel="apple-touch-icon" sizes="120x120" href="/static/icon/apple-120.png" key="apple-icon-120" />
      <link rel="apple-touch-icon" sizes="114x114" href="/static/icon/apple-114.png" key="apple-icon-114" />
      <link rel="apple-touch-icon" sizes="76x76" href="/static/icon/apple-76.png" key="apple-icon-76" />
      <link rel="apple-touch-icon" sizes="72x72" href="/static/icon/apple-72.png" key="apple-icon-72" />
      <link rel="apple-touch-icon" sizes="57x57" href="/static/icon/apple-57.png" key="apple-icon-57" />
    </Head>
  );
}
