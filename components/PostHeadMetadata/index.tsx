...
export default function PageMeta({
  ...
  const meta = [
    ...
    (<meta property="og:url" content={`https://sthom.kiwi${path}`} key="og-url" />),
    (<meta property="twitter:card" content={img ? 'summary_large_image' : 'summary'} key="tw-card" />),
  ...
  if (date) {
    ...
    meta.push(
      (<meta property="article:published_time" content={date.toISOString()} key="og-published" />),
      (<meta property="article:modified_time" content={editedDate.toISOString()} key="og-modified" />),
    );
  }
