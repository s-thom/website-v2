...
export const metadata = {
  ...
  description:
    "A summary of the things I did in the 4 years I was at university.",
  bgcolor: "#15181A",
  date: new Date("2017-11-26T14:25"),
  published: true,
  featured: true
};
...
![Minimal UI design of the Enigma simulator](/static/posts/4yrs-code/enigma.png)
...
![The game screen of Get Bit!](/static/posts/4yrs-code/get-bit.png)
...
[Download (.exe)](/static/posts/4yrs-code/WaitingGame.exe)
...
_[Repository](https://github.com/s-thom/uni-15B-204-BallGame/)_
...
_[Repository (#1)](https://github.com/SecretOnline/NMS-Info/)_
_[Repository (#2)](https://github.com/SecretOnline/Info-Repo/)_
...
![The first version of the Info Repo](/static/posts/4yrs-code/nmsir1.png)
...
![The updated version of the Info Repo](/static/posts/4yrs-code/nmsir2.jpg)
...
It wasn't until we had submitted that we realised that we could have done it wihtout having to deal with transferring items between lists. Time pressure makes spaghetti code ~~possible~~ _probable_.
...
[Repository (#3)](https://github.com/SecretOnline/bot)
...
_[Repository](https://github.com/s-thom/uni-17A-548-ImageRecognition/)_
...
_Note to anyone wanting to use Cloud Vision: Pictures of flowers, cars, and animals are the fastest to process. Probably because of the large amout of training data available to the neural network._

## eBook Reader

**Honours Project, COMP520**

_[Repository](https://github.com/s-thom/520-reader/)_
