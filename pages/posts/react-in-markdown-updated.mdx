...
export const metadata = {
  ...
  description: "(Outdated) How to add React components to Markdown documents",
  date: new Date("2017-11-12T09:20"),
  edited: new Date("2017-11-22T15:45"),
  published: true
};

<PostHeader {...metadata} />

_Edit (22 Nov 2017): Major post restructure. Simplified things a lot by removing a redundant step. Also changed the example slightly_

_Edit (23 Jul 2019): Javascript, and this website, have changed enough that this post is no longer relevant. If you want to read it, it is still here. However, there are better ways of acomplishing these goals now ([MDX](https://mdxjs.com) is probably the best bet right now). As such, the examples on this page will be broken_
