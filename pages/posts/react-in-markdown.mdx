...
export const metadata = {
  ...
  date: new Date("2017-06-26T16:50"),
  edited: new Date("2017-06-27T10:32"),
  published: true
};

<PostHeader {...metadata} />

_An updated version of this post can be found here:_
...
_Note: this was written based on Phenomic 0.21.1. With 1.0 coming soon, this method may not work anymore. I will update the post if needed._
