...
export const metadata = {
  ...
  description: "(Outdated) Building my website from scratch with React Static",
  img: "/static/posts/this-website/banner.png",
  date: new Date("2017-06-01T21:10"),
  edited: new Date("2017-11-23T14:13"),
  published: true
};
...
<LargeLink href="/posts/react-in-markdown/" title="React in Markdown" />
