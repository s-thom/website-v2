...
export const metadata = {
  title: "faucet",
  date: new Date("2017-06-02T15:23"),
...
The repository sitting in my account is a fork of [REANNZ/faucet](https://github.com/reannz/faucet). If you're actually thinking of using it for SDN, _use that version_. It will actually get updated.
