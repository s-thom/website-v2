...
export const metadata = {
  ...
  description: 'A program to quickly generate the JSON structures needed for a Minecraft texture pack',
  img: '/static/projects/on-a-theme-json/lilypads.jpg',
  date: new Date('2017-06-02T15:40'),
