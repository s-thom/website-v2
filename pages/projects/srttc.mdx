...
export const metadata = {
  ...
  description: "Building a tiny type checker for Javascript",
  bgcolor: "#CB3837",
  date: new Date("2018-09-17T00:00"),
  github: "s-thom/srttc",
  published: true,
  featured: true
};
...
const matches = srttc(
  {
    foo: 5,
    bar: {
      baz: [new CoolObject(), new CoolObject()],
      quz: {
...
<LargeLink href="https://www.npmjs.com/package/srttc" title="NPM Package" />
